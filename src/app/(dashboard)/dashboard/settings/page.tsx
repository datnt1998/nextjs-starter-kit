                ...
                <FormField name="bio" control={form.control}>
                  {(field) => (
                    <FormItem>
                      ...
                      <textarea
                        className="w-full min-h-[100px] px-3 py-2 text-sm rounded-lg border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-950 text-neutral-900 dark:text-neutral-50 placeholder:text-neutral-500 dark:placeholder:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <div className="bg-white dark:bg-neutral-900 rounded-lg shadow-sm border border-neutral-200 dark:border-neutral-800 p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-neutral-900 dark:text-neutral-50 font-mono text-sm">
                  {user?.id}
                </p>
              </div>
              <div>
